...
public class Calculator {
    ...
    public Calculator() {
        ...
        final Color mainBack = new Color(184, 198, 219);
    ...
    private JButton initBtn(String label, int x, int y, ActionListener event) {
        ...
        final Color primaryDarkColor = new Color(245, 247, 247);
        final Color secondaryDarkColor = new Color(171, 171, 171);
            ...
            btn.setForeground(secondaryDarkColor);
        window.add(btn);
